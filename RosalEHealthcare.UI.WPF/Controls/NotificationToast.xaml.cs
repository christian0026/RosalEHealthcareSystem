...
namespace RosalEHealthcare.UI.WPF.Controls
{
    public partial class NotificationToast : UserControl
    {
        ...
        private void SetTypeFromString(string type)
        {
            ...
            else
            {
                switch (type?.ToLower())
                {
                    case "success": SetType(NotificationType.Success); break;
                    case "error": SetType(NotificationType.Error); break;
                    case "warning": SetType(NotificationType.Warning); break;
                    case "info": SetType(NotificationType.Info); break;
                    case "newpatient": SetType(NotificationType.NewPatient); break;
                    case "newappointment": SetType(NotificationType.NewAppointment); break;
                    case "appointmentcompleted": SetType(NotificationType.AppointmentCompleted); break;
                    case "appointmentcancelled": SetType(NotificationType.Warning); break;
                    case "lowstock": SetType(NotificationType.LowStock); break;
                    case "expiringmedicine": SetType(NotificationType.ExpiringMedicine); break;
                    default: SetType(NotificationType.Info); break;
                }
            }
        }
            ...
            try
            {
                switch (type?.ToLower())
                {
                    ...
                    case "appointmentcompleted":
                        NotificationSoundPlayer.PlaySuccess();
                        break;
                    case "error":
                    case "appointmentcancelled":
                        NotificationSoundPlayer.PlayError();
                        break;
                    case "warning":
                    case "lowstock":
    ...
    {
        Success, Error, Warning, Info, NewPatient, NewAppointment, AppointmentCompleted, LowStock, ExpiringMedicine
    }
}